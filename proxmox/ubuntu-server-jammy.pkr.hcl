...
build {
    ...
    // Example: Upload configuration files to the VM Template
    // provisioner "file" {
    //     source = "files/dotfiles"
    //     destination = "/home/tbryant"
    // }

    // Example: Run a script to provision the VM Template
    // provisioner "shell" {
    //     inline = [
